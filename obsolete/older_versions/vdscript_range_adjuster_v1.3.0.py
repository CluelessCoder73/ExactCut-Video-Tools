...
def process_vdscript(input_file, output_file, frame_types, i_frame_offset, merge_option, min_gap):
    ranges = []
    ...
    with open(output_file, 'w') as outfile:
        with open(input_file, 'r') as infile:
            for line in infile:
                if not line.startswith('VirtualDub.subset.AddRange'):
                    outfile.write(line)
...
process_vdscript(input_vdscript, output_vdscript, frame_types, i_frame_offset, merge_ranges_option, min_gap_between_ranges)
